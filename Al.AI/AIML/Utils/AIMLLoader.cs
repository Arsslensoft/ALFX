...
namespace Al.AI.AIML.Utils
{
    ...
    public class AIMLLoader
    {
        ...
        public AIMLLoader(Al.AI.AIML.Bot bot)
        {
            this.bot = bot;
        }
        ...
        public string Normalize(string input, bool isUserInput)
        {
            ...
            Normalize.ApplySubstitutions substitutor = new Al.AI.AIML.Normalize.ApplySubstitutions(this.bot);
            Normalize.StripIllegalCharacters stripper = new Al.AI.AIML.Normalize.StripIllegalCharacters(this.bot);
