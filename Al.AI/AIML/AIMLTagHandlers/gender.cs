...
namespace Al.AI.AIML.AIMLTagHandlers
{
    ...
    /// </summary>
    public class gender : Al.AI.AIML.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public gender(Al.AI.AIML.Bot bot,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "gender")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return Al.AI.AIML.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.GenderSubstitutions, this.templateNode.InnerText);
                }
                else
                {
