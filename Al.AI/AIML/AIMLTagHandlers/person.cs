...
namespace Al.AI.AIML.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person : Al.AI.AIML.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public person(Al.AI.AIML.Bot bot,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return Al.AI.AIML.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.PersonSubstitutions, this.templateNode.InnerText);
                }
                else
                {
