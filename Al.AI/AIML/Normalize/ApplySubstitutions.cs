...
namespace Al.AI.AIML.Normalize
{
    ...
    /// </summary>
    public class ApplySubstitutions : Al.AI.AIML.Utils.TextTransformer
    {
        public ApplySubstitutions(Al.AI.AIML.Bot bot, string inputString)
            : base(bot, inputString)
        { }

        public ApplySubstitutions(Al.AI.AIML.Bot bot)
            : base(bot)
        { }
        ...
        public static string Substitute(Al.AI.AIML.Bot bot, Al.AI.AIML.Utils.SettingsDictionary dictionary, string target)
        {
