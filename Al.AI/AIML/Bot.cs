...
using Al.AI.AIML.Utils;

namespace Al.AI.AIML
{
    /// <summary>
    ...
    public class Bot
    {
        ...
        /// </summary>
        public Al.AI.AIML.Utils.Node Graphmaster;
        ...
        public void loadSettings(string pathToSettings)
        {
            ...
            {
                this.GlobalSettings.addSetting("website", "http://sourceforge.net/projects/Al.AI.AIML");
            }
        ...
        public Result Chat(Request request)
        {
            ...
            if (this.isAcceptingUserInput)
            {
                // Normalize the input
                AIMLLoader loader = new AIMLLoader(this);
                Al.AI.AIML.Normalize.SplitIntoSentences splitter = new Al.AI.AIML.Normalize.SplitIntoSentences(this);
        ...
        {
            MailMessage msg = new MailMessage("donotreply@Al.AI.AIML.com",this.AdminEmail);
            msg.Subject = "WARNING! Al.AI.AIML has encountered a problem...";
