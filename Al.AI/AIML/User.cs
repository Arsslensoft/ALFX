...
namespace Al.AI.AIML
{
    ...
    public class User
    {
		...
		/// </summary>
        public Al.AI.AIML.Utils.SettingsDictionary Predicates;
		...
		public User(string UserID, Al.AI.AIML.Bot bot)
		{
            if (UserID.Length > 0)
            {
                this.id = UserID;
                this.bot = bot;
                this.Predicates = new Al.AI.AIML.Utils.SettingsDictionary(this.bot);
