...
using Al.Security.Math.EC.Multiplier;

namespace Al.Security.Math.EC
{
	/**
...
//			F2mFieldElement.CheckFieldElements(a.x, b.x);
		...
		/* (non-Javadoc)
		 * @see Al.Security.math.ec.ECPoint#add(Al.Security.math.ec.ECPoint)
		 */
		...
		/* (non-Javadoc)
		 * @see Al.Security.math.ec.ECPoint#subtract(Al.Security.math.ec.ECPoint)
		 */
		public override ECPoint Subtract(
			ECPoint b)
		{
		...
		/* (non-Javadoc)
		 * @see Al.Security.Math.EC.ECPoint#twice()
		 */
		public override ECPoint Twice()
		{
			// Twice identity element (point at infinity) is identity
