...
using Al.Security.Asn1.X500;
using Al.Security.Math;

namespace Al.Security.Asn1.X509.SigI
{
	/**
	...
	* </pre>
	*
	* @see Al.Security.asn1.x509.sigi.NameOrPseudonym
	* @see Al.Security.asn1.x509.sigi.SigIObjectIdentifiers
	*/
