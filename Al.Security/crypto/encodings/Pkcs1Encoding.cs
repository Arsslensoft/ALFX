...
namespace Al.Security.Crypto.Encodings
{
	/**
	...
	*/
		...
		: IAsymmetricBlockCipher
	{
		 ...
		 * work with one of these set the system property Al.Security.Pkcs1.Strict to false.
		 */
		public const string StrictLengthEnabledProperty = "Al.Security.Pkcs1.Strict";
