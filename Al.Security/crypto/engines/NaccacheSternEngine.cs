...
namespace Al.Security.Crypto.Engines
{
	/**
	...
	*/
		...
		: IAsymmetricBlockCipher
	{
		...
		*
		* @see Al.Security.crypto.AsymmetricBlockCipher#init(bool,
		*      Al.Security.crypto.CipherParameters)
		*/
		public void Init(
			bool				forEncryption,
...
//						accJ = priv.PhiN.Multiply(bigJ);
		...
		*
		* @see Al.Security.crypto.AsymmetricBlockCipher#GetInputBlockSize()
		*/
...
//				return key.Modulus.ToByteArray().Length;
		...
		*
		* @see Al.Security.crypto.AsymmetricBlockCipher#GetOutputBlockSize()
		*/
...
//				return key.Modulus.ToByteArray().Length;
		...
		*
		* @see Al.Security.crypto.AsymmetricBlockCipher#ProcessBlock(byte[],
		*      int, int)
		*/
